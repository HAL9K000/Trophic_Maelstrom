...
int main(int argc, char *argv[])
{
  ...
  double dt_adv[SpB] = {dt_analytical, dtv1, dtv2}; //Time-scales of advection for species.
    ...
    cout << "Displacement invariant advection.\n"; cerr << "Displacement invariant advection selected.\n";
    for(int s = 1; s < SpB; s++)
    ...
    cout << "Velocity invariant advection.\n"; cerr << "Velocity invariant advection selected.\n";
  #endif
  ...
  */
  ...
  cout << "This is a 3Sp (Three) Stochastic FPE MOVEMENT  Rietkerk Model Script WITHOUT DDM AND UNIT INITIALISATION OF CONSUMERS\n";
