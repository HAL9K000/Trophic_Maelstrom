...
int main(int argc, char *argv[])
{
  increase_stack_limit(1024L); //Increase stack limit to 1024 MB.
    ...
    string error_string = "ERROR: The initial condition cannot be set to 2 (Burn-in), Please set the initial condition to 0 or 1 or compile order_3stocDP_burnin.cpp \n";
  ...
  double scaling_factor[2*Sp] = {1, init_frac_graz, init_frac_pred,  1, init_frac_graz, init_frac_pred};
